    ...
    ;(async function () {
      ...
      try {
        ...
        if (isValid) {
          ...
          // (method) Address.toString(isUserFriendly?: boolean | undefined, isUrlSafe?: boolean | undefined, isBounceable?: boolean | undefined, isTestOnly?: boolean | undefined): string
          newWalletAddress = walletAddress.toString(true, true, false, true)
        }
      } catch (e) {
